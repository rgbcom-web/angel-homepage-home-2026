      ...
      <div
        ...
        <Container className={cn("relative tablet:w-[calc(100%-100px)]")}>
          <motion.div style={{ clipPath }}>
            <Video
              src={`/images/products/angel-medi/m20/connected-healthcare-${lang}.mp4`}
            ...
            />
            <Video
              src={`/images/products/angel-medi/m20/connected-healthcare-mo-${lang}.mp4`}
